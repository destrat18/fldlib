...
// for log
#include <cmath>
#include "obj_interface/IntervalTypesSize.h"
...
class TFloatInterval {
  ...
  public:
   ...
   template <typename T> TFloatInterval(T value) requires floating_point_promotion<T, TypeImplementation>
      :  thisType()
      {  initFrom(value); }
   template <typename T> TFloatInterval(T value) requires floating_point_nopromotion<T, TypeImplementation>
      :  thisType()
      {
#ifndef FLOAT_ATOMIC
         DDoubleIntervalInterface::TFloatInterval<LDBL_MANT_DIG-1, (LDBL_MAX_EXP == (1 << (16-2))) ? 15 /* leading 1 bit */ : sizeof(long double)*8-LDBL_MANT_DIG,
   ...
   template <typename T> TFloatInterval(T min, T max)
         requires floating_point_promotion<T, TypeImplementation>
      :  thisType()
      {  initFrom(min, max); }
   template <typename T> TFloatInterval(T min, T max, T errmin, T errmax)
         requires floating_point_promotion<T, TypeImplementation>
      :  thisType()
   ...
   template <typename T> TFloatInterval(T value) requires integral_signed_promotion<T, int64_t>
      :  thisType()
      {  initFrom((int64_t) value); }
   template <typename T> TFloatInterval(T value) requires integral_unsigned_promotion<T, uint64_t>
      :  thisType()
   ...
   template <typename T> thisType& operator=(T value) requires floating_point_promotion<T, TypeImplementation>
      {  initFrom(value); return *this; }
   template <typename T> thisType& operator=(T value) requires floating_point_nopromotion<T, TypeImplementation>
      {
#ifndef FLOAT_ATOMIC
         DDoubleIntervalInterface::TFloatInterval<LDBL_MANT_DIG-1, (LDBL_MAX_EXP == (1 << (16-2))) ? 15 /* leading 1 bit */ : sizeof(long double)*8-LDBL_MANT_DIG,
            long double> receiver;
         receiver.initFrom((long double) value);
         return thisType::operator=(receiver);
#else
         initFrom(TypeImplementation(value)); return *this;
#endif
      }
   ...
   template<typename T> friend auto operator+(const thisType& first, T second)
      ...
      {  TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + T(0))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + T(0))>::UBitSizeExponent,
   ...
   template<typename T> friend auto operator+(T first, const thisType& second)
      -> TFloatInterval<
         ...
         requires std::floating_point<T> || std::integral<T>
      {  TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(T(0) + TypeImplementation(0))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(T(0) + TypeImplementation(0))>::UBitSizeExponent,
   ...
   template <int USizeMantissaArgument, int USizeExponentArgument, typename TypeImplementationArgument>
   friend auto operator+(const thisType& first, const TFloatInterval<USizeMantissaArgument, USizeExponentArgument, TypeImplementationArgument>& second)
      -> TFloatInterval<
      ...
      {  TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + TypeImplementationArgument(0))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + TypeImplementationArgument(0))>::UBitSizeExponent,
   ...
   template<typename T> friend auto operator-(const thisType& first, T second)
      -> TFloatInterval<
            ...
            decltype(TypeImplementation(0) - T(0))>
         requires std::floating_point<T> || std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) - T(0))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) - T(0))>::UBitSizeExponent,
   ...
   template <typename T> friend bool operator<(T first, const thisType& second)
         requires std::floating_point<T> or std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(T(0) + TypeImplementation(0))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(T(0) + TypeImplementation(0))>::UBitSizeExponent,
            decltype(T(0) + TypeImplementation(0))> TypeComparison;
         return TypeComparison::compareLess(TypeComparison(first), second);
      }
   template <int USizeMantissaArgument, int USizeExponentArgument, typename TypeImplementationArgument>
   friend bool operator<(const thisType& first, const TFloatInterval<USizeMantissaArgument, USizeExponentArgument, TypeImplementationArgument>& second)
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + TypeImplementationArgument(0))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + TypeImplementationArgument(0))>::UBitSizeExponent,
   ...
   template <int USizeMantissaArgument, int USizeExponentArgument, typename TypeImplementationArgument>
   friend auto min(const thisType& first, const TFloatInterval<USizeMantissaArgument, USizeExponentArgument, TypeImplementationArgument>& second)
      -> TFloatInterval<
            DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + TypeImplementationArgument(0))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + TypeImplementationArgument(0))>::UBitSizeExponent,
            decltype(TypeImplementation(0) + TypeImplementationArgument(0))>
   ...
   template <int USizeMantissaArgument, int USizeExponentArgument, typename TypeImplementationArgument>
   friend auto max(const thisType& first, const TFloatInterval<USizeMantissaArgument, USizeExponentArgument, TypeImplementationArgument>& second)
      -> TFloatInterval<
            DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + TypeImplementationArgument(0))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(TypeImplementation(0) + TypeImplementationArgument(0))>::UBitSizeExponent,
            decltype(TypeImplementation(0) + TypeImplementationArgument(0))>
   ...
   template<typename T> friend auto pow(const thisType& first, T second)
      -> TFloatInterval<
         ...
         requires std::floating_point<T> || std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(pow(TypeImplementation(0), T(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(pow(TypeImplementation(0), T(0)))>::UBitSizeExponent,
   ...
   template<typename T> friend auto pow(T first, const thisType& second)
      -> TFloatInterval<
         ...
         requires std::floating_point<T> || std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(pow(T(0), TypeImplementation(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(pow(T(0), TypeImplementation(0)))>::UBitSizeExponent,
   ...
   template <int USizeMantissaArgument, int USizeExponentArgument, typename TypeImplementationArgument>
   friend auto pow(const thisType& first, const TFloatInterval<USizeMantissaArgument, USizeExponentArgument, TypeImplementationArgument>& second)
      -> TFloatInterval<
      ...
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(pow(TypeImplementation(0), TypeImplementationArgument(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(pow(TypeImplementation(0), TypeImplementationArgument(0)))>::UBitSizeExponent,
   ...
   template<typename T> friend auto powf(const thisType& first, T second)
      -> TFloatInterval<
         ...
         requires std::floating_point<T> || std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(powf(TypeImplementation(0), T(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(powf(TypeImplementation(0), T(0)))>::UBitSizeExponent,
   ...
   template<typename T> friend auto powf(T first, const thisType& second)
      -> TFloatInterval<
         ...
         requires std::floating_point<T> || std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(powf(T(0), TypeImplementation(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(powf(T(0), TypeImplementation(0)))>::UBitSizeExponent,
   ...
   template <int USizeMantissaArgument, int USizeExponentArgument, typename TypeImplementationArgument>
   friend auto powf(const thisType& first, const TFloatInterval<USizeMantissaArgument, USizeExponentArgument, TypeImplementationArgument>& second)
      -> TFloatInterval<
      ...
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(powf(TypeImplementation(0), TypeImplementationArgument(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(powf(TypeImplementation(0), TypeImplementationArgument(0)))>::UBitSizeExponent,
   ...
   template<typename T> friend auto atan2(const thisType& first, T second)
      -> TFloatInterval<
         ...
         requires std::floating_point<T> || std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(atan2(TypeImplementation(0), T(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(atan2(TypeImplementation(0), T(0)))>::UBitSizeExponent,
   ...
   template<typename T> friend auto atan2(T first, const thisType& second)
      -> TFloatInterval<
         ...
         requires std::floating_point<T> || std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(atan2(T(0), TypeImplementation(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(atan2(T(0), TypeImplementation(0)))>::UBitSizeExponent,
   ...
   template <int USizeMantissaArgument, int USizeExponentArgument, typename TypeImplementationArgument>
   friend auto atan2(const thisType& first, const TFloatInterval<USizeMantissaArgument, USizeExponentArgument, TypeImplementationArgument>& second)
      -> TFloatInterval<
      ...
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(atan2(TypeImplementation(0), TypeImplementationArgument(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(atan2(TypeImplementation(0), TypeImplementationArgument(0)))>::UBitSizeExponent,
   ...
   template<typename T> friend auto fmod(const thisType& first, T second)
      -> TFloatInterval<
         ...
         requires std::floating_point<T> || std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(fmod(TypeImplementation(0), T(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(fmod(TypeImplementation(0), T(0)))>::UBitSizeExponent,
   ...
   template<typename T> friend auto fmod(T first, const thisType& second)
      -> TFloatInterval<
         ...
         requires std::floating_point<T> || std::integral<T>
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(fmod(T(0), TypeImplementation(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(fmod(T(0), TypeImplementation(0)))>::UBitSizeExponent,
   ...
   template <int USizeMantissaArgument, int USizeExponentArgument, typename TypeImplementationArgument>
   friend auto fmod(const thisType& first, const TFloatInterval<USizeMantissaArgument, USizeExponentArgument, TypeImplementationArgument>& second)
      -> TFloatInterval<
      ...
      {  typedef TFloatInterval<DFloatDigitsHelper::TFloatDigits<decltype(fmod(TypeImplementation(0), TypeImplementationArgument(0)))>::UBitSizeMantissa,
            DFloatDigitsHelper::TFloatDigits<decltype(fmod(TypeImplementation(0), TypeImplementationArgument(0)))>::UBitSizeExponent,
