...
template void TBaseFloatExact<ExecutionPath>::assumeCompare<TGCompareFloatExact<FLOAT_REAL_BITS_NUMBER, TBaseFloatExact<ExecutionPath>, TBuiltFloatExact<23, 8>, float> >(TGCompareFloatExact<FLOAT_REAL_BITS_NUMBER, TBaseFloatExact<ExecutionPath>, TBuiltFloatExact<23, 8>, float> const&, TGBuiltReal<Numerics::UnsignedLongBaseStoreTraits, FLOAT_REAL_BITS_NUMBER> const&) const;
template void TBaseFloatExact<ExecutionPath>::writeCompare<TGCompareFloatExact<FLOAT_REAL_BITS_NUMBER, TBaseFloatExact<ExecutionPath>, TBuiltFloatExact<23, 8>, float> >(TGCompareFloatExact<FLOAT_REAL_BITS_NUMBER, TBaseFloatExact<ExecutionPath>, TBuiltFloatExact<23, 8>, float> const&, TGBuiltReal<Numerics::UnsignedLongBaseStoreTraits, FLOAT_REAL_BITS_NUMBER> const&) const;
template class TGCompareFloatExact<FLOAT_REAL_BITS_NUMBER, TBaseFloatExact<ExecutionPath>, TBuiltFloatExact<23, 8>, float>;
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
void
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::initFrom(TypeImplementation value) {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
void
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::initFrom(int64_t value) {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   reinterpret_cast<Implementation*>(content)->operator=(Implementation(value));
}

template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
void
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::initFrom(uint64_t value) {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   reinterpret_cast<Implementation*>(content)->operator=(Implementation(value));
}
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
void
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::initFrom(TypeImplementation value, TypeImplementation error) {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   reinterpret_cast<Implementation*>(content)->initFrom(value);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::compareLess(const thisType& afirst, const thisType& asecond) {
   try {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::compareLessOrEqual(const thisType& afirst, const thisType& asecond) {
   try {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::compareEqual(const thisType& afirst, const thisType& asecond) {
   try {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::compareDifferent(const thisType& afirst, const thisType& asecond) {
   try {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::compareGreaterOrEqual(const thisType& afirst, const thisType& asecond) {
   try {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::compareGreater(const thisType& afirst, const thisType& asecond) {
   try {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
uint32_t
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::asUnsigned(RoundMode mode) const {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   typedef Numerics::DDouble::Access::ReadParameters ReadParametersBase;
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
int64_t
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::asLongInt(RoundMode mode) const {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   typedef Numerics::DDouble::Access::ReadParameters ReadParametersBase;
   return reinterpret_cast<const Implementation*>(content)->asInt((ReadParametersBase::RoundMode) mode);
}
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
uint64_t
TFloatExact<USizeMantissa, USizeExponent, TypeImplementation>::asUnsignedLong(RoundMode mode) const {
   typedef DDoubleExact::TFloatExact<DDoubleExact::ExecutionPath, DDoubleExact::TBuiltFloatExact<USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   typedef Numerics::DDouble::Access::ReadParameters ReadParametersBase;
