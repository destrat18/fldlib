...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
void
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::initFrom(TypeImplementation value) {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   if (!DDoubleInterval::ExecutionPath::doesSupportAtomic() && DDoubleInterval::ExecutionPath::outputTraceFile())
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
void
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::initFrom(
...
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::initFrom(
   ...
   *reinterpret_cast<Implementation*>(content) = Implementation(
         errmin < 0 ? min+errmin : min, errmax > 0 ? max+errmax : max);
}

template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
void
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::initFrom(int64_t value) {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   AssumeCondition(sizeof(Implementation) <= UFloatIntervalSize*sizeof(AlignType))
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
void
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::initFrom(uint64_t value) {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   AssumeCondition(sizeof(Implementation) <= UFloatIntervalSize*sizeof(AlignType))
   *reinterpret_cast<Implementation*>(content) = Implementation(value);
}
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::compareLess(const thisType& afirst, const thisType& asecond) {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::compareLessOrEqual(const thisType& afirst, const thisType& asecond) {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
   return first.operator<=(second);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::compareEqual(const thisType& afirst, const thisType& asecond) {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
   return first.operator==(second);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::compareDifferent(const thisType& afirst, const thisType& asecond) {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
   return first.operator!=(second);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::compareGreaterOrEqual(const thisType& afirst, const thisType& asecond) {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
   return first.operator>=(second);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
bool
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::compareGreater(const thisType& afirst, const thisType& asecond) {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const Implementation& first = *reinterpret_cast<const Implementation*>(afirst.content);
   const Implementation& second = *reinterpret_cast<const Implementation*>(asecond.content);
   return first.operator>(second);
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
TypeImplementation
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::asImplementation() const {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
#ifdef FLOAT_CONCRETE
   return reinterpret_cast<const Implementation*>(content)->asImplementation();
#else
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
int32_t
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::asInt(RoundMode mode) const {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
uint32_t
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::asUnsigned(RoundMode mode) const {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   typedef Numerics::DDouble::Access::ReadParameters ReadParametersBase;
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
int64_t
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::asLongInt(RoundMode mode) const {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   typedef Numerics::DDouble::Access::ReadParameters ReadParametersBase;
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
uint64_t
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::asUnsignedLong(RoundMode mode) const {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   typedef Numerics::DDouble::Access::ReadParameters ReadParametersBase;
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
int
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::sfinite() const {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   return !(reinterpret_cast<const Implementation*>(content)->min().isInftyExponent());
}

template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
int
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::sisfinite() const {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   return !(reinterpret_cast<const Implementation*>(content)->min().isInftyExponent());
}
...
template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
int
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::sisnan() const {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   return reinterpret_cast<const Implementation*>(content)->min().isNaN();
}

template <int USizeMantissa, int USizeExponent, typename TypeImplementation>
int
TFloatInterval<USizeMantissa, USizeExponent, TypeImplementation>::sisinf() const {
   typedef DDoubleInterval::TFloatInterval<DDoubleInterval::ExecutionPath, DDoubleInterval::TBuiltFloat<DDoubleInterval::LongDoubleFloatDigits::UBitSizeMantissa+1, USizeMantissa, USizeExponent>, TypeImplementation> Implementation;
   const auto& implementation = *reinterpret_cast<const Implementation*>(content);
   return implementation.min().isInftyExponent() && !implementation.min().isNaN();
}
