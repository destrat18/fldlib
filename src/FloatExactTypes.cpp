...
template class Numerics::DInteger::TGBigCellInt<Numerics::UnsignedLongBaseStoreTraits, Numerics::DInteger::TGCellIntegerTraits<Numerics::UnsignedLongBaseStoreTraits, (FLOAT_REAL_BITS_NUMBER+8*sizeof(uint64_t)-1)/(8*sizeof(uint64_t))> >;
template class Numerics::DInteger::TGBigCellIntAlgo<Numerics::UnsignedLongBaseStoreTraits, Numerics::DInteger::TGCellIntegerTraits<Numerics::UnsignedLongBaseStoreTraits, (FLOAT_REAL_BITS_NUMBER+8*sizeof(uint64_t)-1)/(8*sizeof(uint64_t))> >;
